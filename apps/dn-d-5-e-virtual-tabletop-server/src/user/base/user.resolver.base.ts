...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Characters], { name: "charactersItems" })
  @nestAccessControl.UseRoles({
    resource: "Characters",
    action: "read",
    possession: "any",
  ...
  async findCharactersItems(
    ...
    const results = await this.service.findCharactersItems(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Maps], { name: "mapsItems" })
  @nestAccessControl.UseRoles({
    resource: "Maps",
    action: "read",
    possession: "any",
  ...
  async findMapsItems(
    @graphql.Parent() parent: User,
    @graphql.Args() args: MapsFindManyArgs
  ): Promise<Maps[]> {
    const results = await this.service.findMapsItems(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Sessions], { name: "sessionsItems" })
  @nestAccessControl.UseRoles({
    resource: "Sessions",
    action: "read",
    possession: "any",
  ...
  async findSessionsItems(
    ...
    const results = await this.service.findSessionsItems(parent.id, args);
