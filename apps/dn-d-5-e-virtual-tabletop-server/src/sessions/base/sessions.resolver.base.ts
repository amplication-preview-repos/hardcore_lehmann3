...
import { CreateSessionsArgs } from "./CreateSessionsArgs";
import { UpdateSessionsArgs } from "./UpdateSessionsArgs";
...
export class SessionsResolverBase {
  ...
  async createSessions(
    @graphql.Args() args: CreateSessionsArgs
  ): Promise<Sessions> {
  ...
  async updateSessions(
    @graphql.Args() args: UpdateSessionsArgs
  ): Promise<Sessions | null> {
    try {
  ...
  async getUser(@graphql.Parent() parent: Sessions): Promise<User | null> {
